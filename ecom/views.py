...
def men_section_view(request):
    ...
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'ecom/mensection.html',{'products':products,'product_count_in_cart':product_count_in_cart})

def women_section_view(request):
    products=models.Product.objects.all()
    if 'product_ids' in request.COOKIES:
        product_ids = request.COOKIES['product_ids']
        counter=product_ids.split('|')
    ...
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'ecom/womensection.html',{'products':products,'product_count_in_cart':product_count_in_cart})

def kid_section_view(request):
    products=models.Product.objects.all()
    if 'product_ids' in request.COOKIES:
        product_ids = request.COOKIES['product_ids']
        counter=product_ids.split('|')
    ...
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'ecom/kidsection.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def groceries_view(request):
    ...
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'ecom/groceries.html',{'products':products,'product_count_in_cart':product_count_in_cart})

def new_arrival_view(request):
    products=models.Product.objects.all()
    if 'product_ids' in request.COOKIES:
        product_ids = request.COOKIES['product_ids']
        counter=product_ids.split('|')
    ...
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'ecom/newarrival.html',{'products':products,'product_count_in_cart':product_count_in_cart})
...
def special_offer_view(request):
    ...
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'ecom/specialoffer.html',{'products':products,'product_count_in_cart':product_count_in_cart})
